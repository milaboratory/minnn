...
input="R1_with_empty_reads.fastq R2_with_empty_reads.fastq"
...
minnn sort -Xmx900M -f --groups G1 G2 --input ${prefix}_extracted.mif --output ${prefix}_sorted.mif
#minnn correct -Xmx900M -f --groups G1 G2 --input ${prefix}_sorted.mif --output ${prefix}_corrected.mif
minnn consensus -Xmx900M -f --groups G1 G2 --min-good-sequence-length 0 --reads-min-good-sequence-length 0 --input ${prefix}_sorted.mif --output ${prefix}_consensus1.mif --not-used-reads-output ${prefix}_consensus_not_used1.mif --original-read-stats ${prefix}_consensus_stats1.txt
#minnn consensus-dma -Xmx900M -f --groups G1 G2 --min-good-sequence-length 0 --reads-min-good-sequence-length 0 --input ${prefix}_sorted.mif --output ${prefix}_consensus2.mif --not-used-reads-output ${prefix}_consensus_not_used2.mif --original-read-stats ${prefix}_consensus_stats2.txt
minnn consensus -Xmx900M -f --groups G1 G2 --min-good-sequence-length 0 --reads-min-good-sequence-length 0 --consensuses-to-separate-groups --input ${prefix}_sorted.mif --output ${prefix}_consensus3.mif --not-used-reads-output ${prefix}_consensus_not_used3.mif --original-read-stats ${prefix}_consensus_stats3.txt
#minnn consensus-dma -Xmx900M -f --groups G1 G2 --min-good-sequence-length 0 --reads-min-good-sequence-length 0 --consensuses-to-separate-groups --input ${prefix}_sorted.mif --output ${prefix}_consensus4.mif --not-used-reads-output ${prefix}_consensus_not_used4.mif --original-read-stats ${prefix}_consensus_stats4.txt
