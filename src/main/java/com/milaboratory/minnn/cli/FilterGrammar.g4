...
simpleFilter : minGroupQuality | avgGroupQuality | groupNCount | groupNFraction | minConsensusReads | len | noWildcards ;
...
noWildcards: NO_WILDCARDS OPEN_PARENTHESIS groupNameOrAll CLOSED_PARENTHESIS ;
